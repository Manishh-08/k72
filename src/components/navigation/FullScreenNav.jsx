        ...
        <div ref={fullScreenRef} id='fullscreennav' className='fullscreennav hidden text-white h-screen overflow-hidden w-full z-50 absolute '>
            ...
            <div ref={fullNavLinksRef} className='relative'>
                <div className='navlink flex w-full justify-between items-start'>
                    ...
                    <div onClick={()=>{
                        setNavOpen(false);
                    }} className='h-36 w-40 relative flex justify-center cursor-pointer'>
                        <div className='h-full w-1 rotate-45 bg-white absolute'></div>
                        <div className='h-full w-1 rotate-135 bg-white absolute'></div>
                    </div>
                </div>
                <div className='py-20'>
                    ...
                    <div className='link origin-top relative border-y-1 border-white'>
                        <h1 className='font-[HeroFont2] text-[8vw] text-center leading-[0.8] pt-5 uppercase'>Blogue</h1>
                        <div className='moveLink absolute text-black flex top-0 bg-lime-300 h-full w-full'>
                            <div className='moveX flex items-center'>
